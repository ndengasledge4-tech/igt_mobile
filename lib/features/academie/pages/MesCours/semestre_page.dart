      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ...List.generate(semestres.length, (index) {
                ...
                child: _SemestreItem(
                  ...
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => CoursDetailPage(semestre: semestre),
                      ),
                    );
                  },
                ),
...
class _SemestreItem extends StatelessWidget {
  ...
  const _SemestreItem({required this.semestre, required this.onTap});

  @override
  Widget build(BuildContext context) {
    // Extraction de S1, S2, S3...
    final numero = semestre.replaceAll('Semestre ', 'S');
