...
class AuthRepository implements RegistrationRepository {
  ...
  Future<String> registerStudent({
    ...
    try {
      ...
      // createUserWithEmailAndPassword connecte automatiquement
      // l’utilisateur. Une demande en attente ne doit pas ouvrir
      // l’espace étudiant.
      try {
        await _authService.signOut();
      } on FirebaseAuthException {
        // Le compte et le profil sont déjà valides. Un échec de
        // déconnexion ne doit pas les supprimer ni transformer
        // l’inscription en échec.
      }
