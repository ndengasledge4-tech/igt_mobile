...
void main() {
  test('passe à success quand le repository réussit', () async {
  ...
  test('expose un message utilisateur quand le repository échoue', () async {
    final controller = AuthController(
      repository: FakeRegistrationRepository(
    ...
    expect(controller.errorMessage, contains('déjà'));
  });
}