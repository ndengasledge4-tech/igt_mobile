...
void main() {
  group('Validators', () {
    ...
    expect(
    Validators.email('amira@igt.edu'),
    isNull,
    );

    expect(
    Validators.email('amira@igt'),
    isNotNull,
    );
    });
    ...
    expect(
    Validators.password('Court1'),
    isNotNull,
    );

    expect(
    Validators.password('Solide2026'),
    isNull,
    );
    });

    test('compare la confirmation du mot de passe', () {
    expect(
    ...
    expect(
    Validators.matricule('2026IG001'),
    isNull,
    );

    expect(
    Validators.matricule('2026/IG/001'),
    isNotNull,
    );
    });
